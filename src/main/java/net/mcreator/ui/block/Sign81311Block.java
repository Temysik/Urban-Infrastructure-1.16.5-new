...
public class Sign81311Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_81311")
	public static final Block block = null;

	public Sign81311Block(UiModElements instance) {
		super(instance, 58);
	}
