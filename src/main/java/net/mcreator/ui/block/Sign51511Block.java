...
public class Sign51511Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51511")
	public static final Block block = null;

	public Sign51511Block(UiModElements instance) {
		super(instance, 34);
	}
