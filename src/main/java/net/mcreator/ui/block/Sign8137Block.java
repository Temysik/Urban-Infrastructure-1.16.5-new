...
public class Sign8137Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8137")
	public static final Block block = null;

	public Sign8137Block(UiModElements instance) {
		super(instance, 58);
	}
