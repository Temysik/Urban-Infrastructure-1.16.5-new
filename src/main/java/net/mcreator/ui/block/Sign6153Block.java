...
public class Sign6153Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_6153")
	public static final Block block = null;

	public Sign6153Block(UiModElements instance) {
		super(instance, 49);
	}
