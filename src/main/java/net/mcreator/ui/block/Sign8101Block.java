...
public class Sign8101Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8101")
	public static final Block block = null;

	public Sign8101Block(UiModElements instance) {
		super(instance, 66);
	}
