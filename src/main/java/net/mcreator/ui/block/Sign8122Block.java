...
public class Sign8122Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8122")
	public static final Block block = null;

	public Sign8122Block(UiModElements instance) {
		super(instance, 56);
	}
