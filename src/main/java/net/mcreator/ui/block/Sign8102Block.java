...
public class Sign8102Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8102")
	public static final Block block = null;

	public Sign8102Block(UiModElements instance) {
		super(instance, 66);
	}
