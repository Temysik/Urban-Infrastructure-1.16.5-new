...
public class Apteka2Block extends UiModElements.ModElement {
	@ObjectHolder("ui:apteka_2")
	public static final Block block = null;

	public Apteka2Block(UiModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(32, 0, 1, -16, 16, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-16, 0, 15, 32, 16, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(1, 0, -16, 0, 16, 32))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(15, 0, 32, 16, 16, -16))
