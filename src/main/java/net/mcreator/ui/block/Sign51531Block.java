...
public class Sign51531Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51531")
	public static final Block block = null;

	public Sign51531Block(UiModElements instance) {
		super(instance, 37);
	}
