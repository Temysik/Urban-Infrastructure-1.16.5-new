...
public class TempSign29Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_29")
	public static final Block block = null;

	public TempSign29Block(UiModElements instance) {
		super(instance, 118);
	}
