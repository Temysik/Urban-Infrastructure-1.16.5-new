...
public class TempSign4Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_4")
	public static final Block block = null;

	public TempSign4Block(UiModElements instance) {
		super(instance, 115);
	}
