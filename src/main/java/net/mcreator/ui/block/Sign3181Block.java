...
public class Sign3181Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3181")
	public static final Block block = null;

	public Sign3181Block(UiModElements instance) {
		super(instance, 19);
	}
