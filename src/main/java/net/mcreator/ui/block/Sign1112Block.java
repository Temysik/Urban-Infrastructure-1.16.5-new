...
public class Sign1112Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1112")
	public static final Block block = null;

	public Sign1112Block(UiModElements instance) {
		super(instance, 8);
	}
