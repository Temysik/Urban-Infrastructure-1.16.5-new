...
public class TempSign13Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_13")
	public static final Block block = null;

	public TempSign13Block(UiModElements instance) {
		super(instance, 116);
	}
