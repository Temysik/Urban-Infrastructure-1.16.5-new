...
public class Sign8133Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8133")
	public static final Block block = null;

	public Sign8133Block(UiModElements instance) {
		super(instance, 57);
	}
