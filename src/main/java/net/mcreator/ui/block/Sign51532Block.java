...
public class Sign51532Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51532")
	public static final Block block = null;

	public Sign51532Block(UiModElements instance) {
		super(instance, 37);
	}
