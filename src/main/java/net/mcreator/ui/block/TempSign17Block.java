...
public class TempSign17Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_17")
	public static final Block block = null;

	public TempSign17Block(UiModElements instance) {
		super(instance, 116);
	}
