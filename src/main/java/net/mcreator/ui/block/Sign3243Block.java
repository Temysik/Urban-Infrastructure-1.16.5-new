...
public class Sign3243Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3243")
	public static final Block block = null;

	public Sign3243Block(UiModElements instance) {
		super(instance, 20);
	}
