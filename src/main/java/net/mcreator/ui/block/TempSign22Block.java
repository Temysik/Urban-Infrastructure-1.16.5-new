...
public class TempSign22Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_22")
	public static final Block block = null;

	public TempSign22Block(UiModElements instance) {
		super(instance, 117);
	}
