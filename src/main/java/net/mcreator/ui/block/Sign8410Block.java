...
public class Sign8410Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8410")
	public static final Block block = null;

	public Sign8410Block(UiModElements instance) {
		super(instance, 64);
	}
