...
public class Sign1203Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1203")
	public static final Block block = null;

	public Sign1203Block(UiModElements instance) {
		super(instance, 10);
	}
