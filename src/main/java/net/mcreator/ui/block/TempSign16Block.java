...
public class TempSign16Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_16")
	public static final Block block = null;

	public TempSign16Block(UiModElements instance) {
		super(instance, 116);
	}
