...
public class TempSign37Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_37")
	public static final Block block = null;

	public TempSign37Block(UiModElements instance) {
		super(instance, 119);
	}
