...
public class Sign5122Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5122")
	public static final Block block = null;

	public Sign5122Block(UiModElements instance) {
		super(instance, 31);
	}
