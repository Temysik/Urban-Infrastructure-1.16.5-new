...
public class Sign51510Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51510")
	public static final Block block = null;

	public Sign51510Block(UiModElements instance) {
		super(instance, 34);
	}
