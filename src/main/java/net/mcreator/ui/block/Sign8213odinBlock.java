...
public class Sign8213odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8213odin")
	public static final Block block = null;

	public Sign8213odinBlock(UiModElements instance) {
		super(instance, 69);
	}
