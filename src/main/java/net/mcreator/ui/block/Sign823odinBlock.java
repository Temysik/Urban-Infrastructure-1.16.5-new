...
public class Sign823odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_823odin")
	public static final Block block = null;

	public Sign823odinBlock(UiModElements instance) {
		super(instance, 70);
	}
