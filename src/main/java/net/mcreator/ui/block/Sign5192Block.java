...
public class Sign5192Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5192")
	public static final Block block = null;

	public Sign5192Block(UiModElements instance) {
		super(instance, 40);
	}
