...
public class Sign8137odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8137odin")
	public static final Block block = null;

	public Sign8137odinBlock(UiModElements instance) {
		super(instance, 67);
	}
