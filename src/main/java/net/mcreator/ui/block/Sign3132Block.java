...
public class Sign3132Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3132")
	public static final Block block = null;

	public Sign3132Block(UiModElements instance) {
		super(instance, 18);
	}
