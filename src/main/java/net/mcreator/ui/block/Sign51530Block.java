...
public class Sign51530Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51530")
	public static final Block block = null;

	public Sign51530Block(UiModElements instance) {
		super(instance, 37);
	}
