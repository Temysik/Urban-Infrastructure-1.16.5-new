...
public class Sign8136odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8136odin")
	public static final Block block = null;

	public Sign8136odinBlock(UiModElements instance) {
		super(instance, 67);
	}
