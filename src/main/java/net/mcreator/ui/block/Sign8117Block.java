...
public class Sign8117Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8117")
	public static final Block block = null;

	public Sign8117Block(UiModElements instance) {
		super(instance, 56);
	}
