...
public class TempSign11Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_11")
	public static final Block block = null;

	public TempSign11Block(UiModElements instance) {
		super(instance, 115);
	}
