...
public class Ozon1Block extends UiModElements.ModElement {
	@ObjectHolder("ui:ozon_1")
	public static final Block block = null;

	public Ozon1Block(UiModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(15, 1, 15, 1, 15, 1))
				...
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(1, 1, 1, 15, 15, 15))
							...
							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(15, 1, 1, 1, 15, 15))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(1, 1, 15, 15, 15, 1))
