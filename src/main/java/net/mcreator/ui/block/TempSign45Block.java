...
public class TempSign45Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_45")
	public static final Block block = null;

	public TempSign45Block(UiModElements instance) {
		super(instance, 120);
	}
