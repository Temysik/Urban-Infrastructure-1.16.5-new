...
public class TempSign6Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_6")
	public static final Block block = null;

	public TempSign6Block(UiModElements instance) {
		super(instance, 115);
	}
