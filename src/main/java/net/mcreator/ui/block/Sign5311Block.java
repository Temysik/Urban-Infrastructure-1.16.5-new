...
public class Sign5311Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5311")
	public static final Block block = null;

	public Sign5311Block(UiModElements instance) {
		super(instance, 42);
	}
