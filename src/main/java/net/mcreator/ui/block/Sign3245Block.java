...
public class Sign3245Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3245")
	public static final Block block = null;

	public Sign3245Block(UiModElements instance) {
		super(instance, 21);
	}
