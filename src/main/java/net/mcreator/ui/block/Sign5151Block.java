...
public class Sign5151Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5151")
	public static final Block block = null;

	public Sign5151Block(UiModElements instance) {
		super(instance, 32);
	}
