...
public class TempSign38Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_38")
	public static final Block block = null;

	public TempSign38Block(UiModElements instance) {
		super(instance, 119);
	}
