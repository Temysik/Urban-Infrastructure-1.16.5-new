...
public class Sign3251Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3251")
	public static final Block block = null;

	public Sign3251Block(UiModElements instance) {
		super(instance, 21);
	}
