...
public class StorageBoxBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:storage_box")
	public static final Block block = null;

	public StorageBoxBlock(UiModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(17, 0, 17, 0, 16, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-1, 0, -1, 16, 16, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(17, 0, -1, 0, 16, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-1, 0, 17, 16, 16, 0))
