...
public class Sign1122Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1122")
	public static final Block block = null;

	public Sign1122Block(UiModElements instance) {
		super(instance, 9);
	}
