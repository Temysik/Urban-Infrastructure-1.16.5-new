...
public class Sign5153Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5153")
	public static final Block block = null;

	public Sign5153Block(UiModElements instance) {
		super(instance, 33);
	}
