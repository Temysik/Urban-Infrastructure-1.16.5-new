...
public class Sign51527Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51527")
	public static final Block block = null;

	public Sign51527Block(UiModElements instance) {
		super(instance, 37);
	}
