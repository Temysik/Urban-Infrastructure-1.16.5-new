...
public class Sign3252Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3252")
	public static final Block block = null;

	public Sign3252Block(UiModElements instance) {
		super(instance, 21);
	}
