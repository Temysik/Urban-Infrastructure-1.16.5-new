...
public class Sign3172Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3172")
	public static final Block block = null;

	public Sign3172Block(UiModElements instance) {
		super(instance, 19);
	}
