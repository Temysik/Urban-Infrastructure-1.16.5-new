...
public class Sign5141Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5141")
	public static final Block block = null;

	public Sign5141Block(UiModElements instance) {
		super(instance, 32);
	}
