...
public class TempSign40Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_40")
	public static final Block block = null;

	public TempSign40Block(UiModElements instance) {
		super(instance, 119);
	}
