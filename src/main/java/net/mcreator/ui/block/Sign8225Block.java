...
public class Sign8225Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8225")
	public static final Block block = null;

	public Sign8225Block(UiModElements instance) {
		super(instance, 60);
	}
