...
public class Sign3112Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3112")
	public static final Block block = null;

	public Sign3112Block(UiModElements instance) {
		super(instance, 17);
	}
