...
public class TempSign24Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_24")
	public static final Block block = null;

	public TempSign24Block(UiModElements instance) {
		super(instance, 117);
	}
