...
public class Sign8252Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8252")
	public static final Block block = null;

	public Sign8252Block(UiModElements instance) {
		super(instance, 60);
	}
