...
public class TempSign18Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_18")
	public static final Block block = null;

	public TempSign18Block(UiModElements instance) {
		super(instance, 116);
	}
