...
public class ShelfBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:shelf")
	public static final Block block = null;

	public ShelfBlock(UiModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 7, 1, 5, -15))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 0, 9, 15, 5, 31))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(7, 0, 0, -15, 5, 15))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(9, 0, 16, 31, 5, 1))
