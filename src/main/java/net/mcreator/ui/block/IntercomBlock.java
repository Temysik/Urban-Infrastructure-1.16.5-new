...
public class IntercomBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:intercom")
	public static final Block block = null;

	public IntercomBlock(UiModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(11, 0, 2, 4, 12, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(5, 0, 14, 12, 12, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(2, 0, 5, 0, 12, 12))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(14, 0, 11, 16, 12, 4))
