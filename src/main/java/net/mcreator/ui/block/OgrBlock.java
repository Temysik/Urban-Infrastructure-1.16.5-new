...
public class OgrBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:ogr")
	public static final Block block = null;

	public OgrBlock(UiModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(17, 0, 5, -15, 31, -3))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-1, 0, 11, 31, 31, 19))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(5, 0, -1, -3, 31, 31))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(11, 0, 17, 19, 31, -15))
