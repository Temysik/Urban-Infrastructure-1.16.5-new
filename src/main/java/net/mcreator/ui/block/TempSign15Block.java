...
public class TempSign15Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_15")
	public static final Block block = null;

	public TempSign15Block(UiModElements instance) {
		super(instance, 116);
	}
