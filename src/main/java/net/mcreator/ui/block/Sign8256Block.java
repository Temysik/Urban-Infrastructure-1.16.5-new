...
public class Sign8256Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8256")
	public static final Block block = null;

	public Sign8256Block(UiModElements instance) {
		super(instance, 62);
	}
