...
public class Sign8136Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8136")
	public static final Block block = null;

	public Sign8136Block(UiModElements instance) {
		super(instance, 58);
	}
