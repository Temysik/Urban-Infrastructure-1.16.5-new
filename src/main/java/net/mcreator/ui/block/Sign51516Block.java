...
public class Sign51516Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51516")
	public static final Block block = null;

	public Sign51516Block(UiModElements instance) {
		super(instance, 35);
	}
