...
public class Sign5193Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5193")
	public static final Block block = null;

	public Sign5193Block(UiModElements instance) {
		super(instance, 40);
	}
