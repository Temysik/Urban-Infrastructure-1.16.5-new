...
public class Sign3131Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3131")
	public static final Block block = null;

	public Sign3131Block(UiModElements instance) {
		super(instance, 17);
	}
