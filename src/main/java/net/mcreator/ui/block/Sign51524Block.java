...
public class Sign51524Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51524")
	public static final Block block = null;

	public Sign51524Block(UiModElements instance) {
		super(instance, 36);
	}
