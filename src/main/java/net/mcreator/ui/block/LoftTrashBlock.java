...
public class LoftTrashBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:loft_trash")
	public static final Block block = null;

	public LoftTrashBlock(UiModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(15, 0, 15, 3, 12, 3))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(1, 0, 1, 13, 12, 13))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(15, 0, 1, 3, 12, 13))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(1, 0, 15, 13, 12, 3))
