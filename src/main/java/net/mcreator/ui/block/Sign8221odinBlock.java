...
public class Sign8221odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8221odin")
	public static final Block block = null;

	public Sign8221odinBlock(UiModElements instance) {
		super(instance, 69);
	}
