...
public class Sign1202Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1202")
	public static final Block block = null;

	public Sign1202Block(UiModElements instance) {
		super(instance, 10);
	}
