...
public class Curb2Block extends UiModElements.ModElement {
	@ObjectHolder("ui:curb_2")
	public static final Block block = null;

	public Curb2Block(UiModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(17, 0, 17, 0, 2, 14.5))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-1, 0, -1, 16, 2, 1.5))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(17, 0, -1, 14.5, 2, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-1, 0, 17, 1.5, 2, 0))
