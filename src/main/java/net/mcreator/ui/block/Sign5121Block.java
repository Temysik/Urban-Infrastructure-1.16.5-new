...
public class Sign5121Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5121")
	public static final Block block = null;

	public Sign5121Block(UiModElements instance) {
		super(instance, 31);
	}
