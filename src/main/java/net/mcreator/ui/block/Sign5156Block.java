...
public class Sign5156Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5156")
	public static final Block block = null;

	public Sign5156Block(UiModElements instance) {
		super(instance, 33);
	}
