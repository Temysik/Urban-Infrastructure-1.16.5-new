...
public class TempSign41Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_41")
	public static final Block block = null;

	public TempSign41Block(UiModElements instance) {
		super(instance, 119);
	}
