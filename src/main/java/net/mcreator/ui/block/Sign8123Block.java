...
public class Sign8123Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8123")
	public static final Block block = null;

	public Sign8123Block(UiModElements instance) {
		super(instance, 57);
	}
