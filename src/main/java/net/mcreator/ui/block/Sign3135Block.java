...
public class Sign3135Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3135")
	public static final Block block = null;

	public Sign3135Block(UiModElements instance) {
		super(instance, 18);
	}
