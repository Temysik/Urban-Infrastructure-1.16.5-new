...
public class TempSign34Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_34")
	public static final Block block = null;

	public TempSign34Block(UiModElements instance) {
		super(instance, 118);
	}
