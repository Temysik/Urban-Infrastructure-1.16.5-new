...
public class Sign5158Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5158")
	public static final Block block = null;

	public Sign5158Block(UiModElements instance) {
		super(instance, 33);
	}
