...
public class Sign3173Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3173")
	public static final Block block = null;

	public Sign3173Block(UiModElements instance) {
		super(instance, 19);
	}
