...
public class ConditionerBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:conditioner")
	public static final Block block = null;

	public ConditionerBlock(UiModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(19, 0, 10, -2, 13, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-3, 0, 6, 18, 13, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(10, 0, -3, 0, 13, 18))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(6, 0, 19, 16, 13, -2))
