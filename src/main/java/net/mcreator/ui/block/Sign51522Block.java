...
public class Sign51522Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51522")
	public static final Block block = null;

	public Sign51522Block(UiModElements instance) {
		super(instance, 36);
	}
