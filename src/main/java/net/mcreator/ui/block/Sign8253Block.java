...
public class Sign8253Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8253")
	public static final Block block = null;

	public Sign8253Block(UiModElements instance) {
		super(instance, 60);
	}
