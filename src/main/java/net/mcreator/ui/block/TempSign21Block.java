...
public class TempSign21Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_21")
	public static final Block block = null;

	public TempSign21Block(UiModElements instance) {
		super(instance, 117);
	}
