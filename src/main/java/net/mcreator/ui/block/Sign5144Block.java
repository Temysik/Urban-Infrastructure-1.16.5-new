...
public class Sign5144Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5144")
	public static final Block block = null;

	public Sign5144Block(UiModElements instance) {
		super(instance, 32);
	}
