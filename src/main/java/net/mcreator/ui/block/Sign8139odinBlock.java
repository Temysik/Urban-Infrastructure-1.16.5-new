...
public class Sign8139odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8139odin")
	public static final Block block = null;

	public Sign8139odinBlock(UiModElements instance) {
		super(instance, 68);
	}
