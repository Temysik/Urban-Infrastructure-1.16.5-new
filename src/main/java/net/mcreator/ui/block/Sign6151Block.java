...
public class Sign6151Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_6151")
	public static final Block block = null;

	public Sign6151Block(UiModElements instance) {
		super(instance, 48);
	}
