...
public class Sign8216Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8216")
	public static final Block block = null;

	public Sign8216Block(UiModElements instance) {
		super(instance, 60);
	}
