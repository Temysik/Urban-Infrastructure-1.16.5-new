...
public class Sign51537Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51537")
	public static final Block block = null;

	public Sign51537Block(UiModElements instance) {
		super(instance, 38);
	}
