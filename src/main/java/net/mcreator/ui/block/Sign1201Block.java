...
public class Sign1201Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1201")
	public static final Block block = null;

	public Sign1201Block(UiModElements instance) {
		super(instance, 10);
	}
