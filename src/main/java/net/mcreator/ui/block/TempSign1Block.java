...
public class TempSign1Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_1")
	public static final Block block = null;

	public TempSign1Block(UiModElements instance) {
		super(instance, 114);
	}
