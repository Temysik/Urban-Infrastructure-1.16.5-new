...
public class Sign5134Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5134")
	public static final Block block = null;

	public Sign5134Block(UiModElements instance) {
		super(instance, 31);
	}
