...
public class TempSign47Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_47")
	public static final Block block = null;

	public TempSign47Block(UiModElements instance) {
		super(instance, 120);
	}
