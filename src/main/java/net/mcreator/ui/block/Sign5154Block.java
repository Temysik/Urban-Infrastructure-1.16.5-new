...
public class Sign5154Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5154")
	public static final Block block = null;

	public Sign5154Block(UiModElements instance) {
		super(instance, 33);
	}
