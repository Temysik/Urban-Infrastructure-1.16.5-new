...
public class Sign8215Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8215")
	public static final Block block = null;

	public Sign8215Block(UiModElements instance) {
		super(instance, 59);
	}
