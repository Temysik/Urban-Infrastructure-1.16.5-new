...
public class Sign8213Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8213")
	public static final Block block = null;

	public Sign8213Block(UiModElements instance) {
		super(instance, 59);
	}
