...
public class Sign131odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_131odin")
	public static final Block block = null;

	public Sign131odinBlock(UiModElements instance) {
		super(instance, 12);
	}
