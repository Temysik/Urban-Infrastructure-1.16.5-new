...
public class TempSign8Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_8")
	public static final Block block = null;

	public TempSign8Block(UiModElements instance) {
		super(instance, 115);
	}
