...
public class Sign5321Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5321")
	public static final Block block = null;

	public Sign5321Block(UiModElements instance) {
		super(instance, 42);
	}
