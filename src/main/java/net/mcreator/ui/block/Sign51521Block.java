...
public class Sign51521Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51521")
	public static final Block block = null;

	public Sign51521Block(UiModElements instance) {
		super(instance, 36);
	}
