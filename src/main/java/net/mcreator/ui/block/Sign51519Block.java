...
public class Sign51519Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51519")
	public static final Block block = null;

	public Sign51519Block(UiModElements instance) {
		super(instance, 35);
	}
