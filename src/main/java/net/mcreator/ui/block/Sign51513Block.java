...
public class Sign51513Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51513")
	public static final Block block = null;

	public Sign51513Block(UiModElements instance) {
		super(instance, 34);
	}
