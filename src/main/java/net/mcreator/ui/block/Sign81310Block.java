...
public class Sign81310Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_81310")
	public static final Block block = null;

	public Sign81310Block(UiModElements instance) {
		super(instance, 58);
	}
