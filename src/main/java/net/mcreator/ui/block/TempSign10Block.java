...
public class TempSign10Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_10")
	public static final Block block = null;

	public TempSign10Block(UiModElements instance) {
		super(instance, 115);
	}
