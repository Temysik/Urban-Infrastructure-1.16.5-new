...
public class Sign8138odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8138odin")
	public static final Block block = null;

	public Sign8138odinBlock(UiModElements instance) {
		super(instance, 67);
	}
