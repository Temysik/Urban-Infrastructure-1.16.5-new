...
public class Sign8134odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8134odin")
	public static final Block block = null;

	public Sign8134odinBlock(UiModElements instance) {
		super(instance, 67);
	}
