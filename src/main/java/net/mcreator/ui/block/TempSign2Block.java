...
public class TempSign2Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_2")
	public static final Block block = null;

	public TempSign2Block(UiModElements instance) {
		super(instance, 114);
	}
