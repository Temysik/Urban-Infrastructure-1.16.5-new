...
public class Sign3111Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3111")
	public static final Block block = null;

	public Sign3111Block(UiModElements instance) {
		super(instance, 17);
	}
