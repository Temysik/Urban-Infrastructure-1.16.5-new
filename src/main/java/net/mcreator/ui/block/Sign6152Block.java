...
public class Sign6152Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_6152")
	public static final Block block = null;

	public Sign6152Block(UiModElements instance) {
		super(instance, 48);
	}
