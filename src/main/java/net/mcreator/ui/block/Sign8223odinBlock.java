...
public class Sign8223odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8223odin")
	public static final Block block = null;

	public Sign8223odinBlock(UiModElements instance) {
		super(instance, 70);
	}
