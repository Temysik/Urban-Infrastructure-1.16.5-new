...
public class Sign3141Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3141")
	public static final Block block = null;

	public Sign3141Block(UiModElements instance) {
		super(instance, 19);
	}
