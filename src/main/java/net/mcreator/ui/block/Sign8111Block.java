...
public class Sign8111Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8111")
	public static final Block block = null;

	public Sign8111Block(UiModElements instance) {
		super(instance, 55);
	}
