...
public class Sign51528Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51528")
	public static final Block block = null;

	public Sign51528Block(UiModElements instance) {
		super(instance, 37);
	}
