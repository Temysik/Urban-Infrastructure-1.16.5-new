...
public class Sign8212odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8212odin")
	public static final Block block = null;

	public Sign8212odinBlock(UiModElements instance) {
		super(instance, 69);
	}
