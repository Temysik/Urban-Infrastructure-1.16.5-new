...
public class Sign3241Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3241")
	public static final Block block = null;

	public Sign3241Block(UiModElements instance) {
		super(instance, 20);
	}
