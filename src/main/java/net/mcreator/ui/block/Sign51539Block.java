...
public class Sign51539Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51539")
	public static final Block block = null;

	public Sign51539Block(UiModElements instance) {
		super(instance, 39);
	}
