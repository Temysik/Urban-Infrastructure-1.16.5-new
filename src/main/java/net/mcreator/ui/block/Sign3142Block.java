...
public class Sign3142Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3142")
	public static final Block block = null;

	public Sign3142Block(UiModElements instance) {
		super(instance, 19);
	}
