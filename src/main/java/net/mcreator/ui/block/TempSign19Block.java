...
public class TempSign19Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_19")
	public static final Block block = null;

	public TempSign19Block(UiModElements instance) {
		super(instance, 116);
	}
