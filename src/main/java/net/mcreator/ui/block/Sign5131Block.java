...
public class Sign5131Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5131")
	public static final Block block = null;

	public Sign5131Block(UiModElements instance) {
		super(instance, 31);
	}
