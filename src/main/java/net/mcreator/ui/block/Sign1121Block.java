...
public class Sign1121Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1121")
	public static final Block block = null;

	public Sign1121Block(UiModElements instance) {
		super(instance, 9);
	}
