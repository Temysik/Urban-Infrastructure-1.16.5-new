...
public class Sign8254Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8254")
	public static final Block block = null;

	public Sign8254Block(UiModElements instance) {
		super(instance, 62);
	}
