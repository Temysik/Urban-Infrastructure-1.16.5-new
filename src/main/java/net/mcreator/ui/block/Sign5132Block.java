...
public class Sign5132Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5132")
	public static final Block block = null;

	public Sign5132Block(UiModElements instance) {
		super(instance, 31);
	}
