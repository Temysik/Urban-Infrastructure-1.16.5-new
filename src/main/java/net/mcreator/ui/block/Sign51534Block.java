...
public class Sign51534Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51534")
	public static final Block block = null;

	public Sign51534Block(UiModElements instance) {
		super(instance, 38);
	}
