...
public class Sign5159Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5159")
	public static final Block block = null;

	public Sign5159Block(UiModElements instance) {
		super(instance, 34);
	}
