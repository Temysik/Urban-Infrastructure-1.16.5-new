...
public class Sign51512Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51512")
	public static final Block block = null;

	public Sign51512Block(UiModElements instance) {
		super(instance, 34);
	}
