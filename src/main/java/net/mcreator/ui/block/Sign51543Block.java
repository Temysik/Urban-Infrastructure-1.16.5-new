...
public class Sign51543Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51543")
	public static final Block block = null;

	public Sign51543Block(UiModElements instance) {
		super(instance, 39);
	}
