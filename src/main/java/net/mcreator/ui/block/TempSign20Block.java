...
public class TempSign20Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_20")
	public static final Block block = null;

	public TempSign20Block(UiModElements instance) {
		super(instance, 117);
	}
