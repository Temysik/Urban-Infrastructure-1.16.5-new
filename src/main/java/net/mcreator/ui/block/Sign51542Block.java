...
public class Sign51542Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51542")
	public static final Block block = null;

	public Sign51542Block(UiModElements instance) {
		super(instance, 39);
	}
