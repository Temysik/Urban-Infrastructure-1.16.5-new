...
public class TempSign3Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_3")
	public static final Block block = null;

	public TempSign3Block(UiModElements instance) {
		super(instance, 114);
	}
