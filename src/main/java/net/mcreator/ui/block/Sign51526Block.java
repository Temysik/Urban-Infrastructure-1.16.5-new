...
public class Sign51526Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51526")
	public static final Block block = null;

	public Sign51526Block(UiModElements instance) {
		super(instance, 36);
	}
