...
public class Sign8255Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8255")
	public static final Block block = null;

	public Sign8255Block(UiModElements instance) {
		super(instance, 62);
	}
