...
public class TempSign5Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_5")
	public static final Block block = null;

	public TempSign5Block(UiModElements instance) {
		super(instance, 115);
	}
