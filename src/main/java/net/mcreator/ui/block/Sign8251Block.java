...
public class Sign8251Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8251")
	public static final Block block = null;

	public Sign8251Block(UiModElements instance) {
		super(instance, 60);
	}
