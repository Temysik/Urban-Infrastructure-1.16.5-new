...
public class Sign8222Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8222")
	public static final Block block = null;

	public Sign8222Block(UiModElements instance) {
		super(instance, 60);
	}
