...
public class Sign8138Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8138")
	public static final Block block = null;

	public Sign8138Block(UiModElements instance) {
		super(instance, 58);
	}
