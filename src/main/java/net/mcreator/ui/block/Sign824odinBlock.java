...
public class Sign824odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_824odin")
	public static final Block block = null;

	public Sign824odinBlock(UiModElements instance) {
		super(instance, 70);
	}
