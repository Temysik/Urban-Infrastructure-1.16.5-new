...
public class Sign5111Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5111")
	public static final Block block = null;

	public Sign5111Block(UiModElements instance) {
		super(instance, 30);
	}
