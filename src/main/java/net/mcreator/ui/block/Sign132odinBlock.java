...
public class Sign132odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_132odin")
	public static final Block block = null;

	public Sign132odinBlock(UiModElements instance) {
		super(instance, 12);
	}
