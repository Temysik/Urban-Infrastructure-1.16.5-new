...
public class TempSign23Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_23")
	public static final Block block = null;

	public TempSign23Block(UiModElements instance) {
		super(instance, 117);
	}
