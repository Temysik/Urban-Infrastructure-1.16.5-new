...
public class Sign8217Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8217")
	public static final Block block = null;

	public Sign8217Block(UiModElements instance) {
		super(instance, 60);
	}
