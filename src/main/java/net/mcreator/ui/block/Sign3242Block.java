...
public class Sign3242Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3242")
	public static final Block block = null;

	public Sign3242Block(UiModElements instance) {
		super(instance, 20);
	}
