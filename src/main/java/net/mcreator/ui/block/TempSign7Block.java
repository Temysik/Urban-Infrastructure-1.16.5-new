...
public class TempSign7Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_7")
	public static final Block block = null;

	public TempSign7Block(UiModElements instance) {
		super(instance, 115);
	}
