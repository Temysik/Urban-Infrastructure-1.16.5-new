...
public class TempSign14Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_14")
	public static final Block block = null;

	public TempSign14Block(UiModElements instance) {
		super(instance, 116);
	}
