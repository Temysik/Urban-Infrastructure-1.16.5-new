...
public class Sign8114Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8114")
	public static final Block block = null;

	public Sign8114Block(UiModElements instance) {
		super(instance, 56);
	}
