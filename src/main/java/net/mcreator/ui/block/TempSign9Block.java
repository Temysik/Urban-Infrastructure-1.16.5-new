...
public class TempSign9Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_9")
	public static final Block block = null;

	public TempSign9Block(UiModElements instance) {
		super(instance, 115);
	}
