...
public class Sign8132Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8132")
	public static final Block block = null;

	public Sign8132Block(UiModElements instance) {
		super(instance, 57);
	}
