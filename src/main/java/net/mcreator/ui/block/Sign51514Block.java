...
public class Sign51514Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51514")
	public static final Block block = null;

	public Sign51514Block(UiModElements instance) {
		super(instance, 34);
	}
