...
public class Sign1343Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1343")
	public static final Block block = null;

	public Sign1343Block(UiModElements instance) {
		super(instance, 13);
	}
