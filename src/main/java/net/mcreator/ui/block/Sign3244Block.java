...
public class Sign3244Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3244")
	public static final Block block = null;

	public Sign3244Block(UiModElements instance) {
		super(instance, 21);
	}
