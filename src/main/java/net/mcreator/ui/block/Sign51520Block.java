...
public class Sign51520Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51520")
	public static final Block block = null;

	public Sign51520Block(UiModElements instance) {
		super(instance, 35);
	}
