...
public class Sign51544Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51544")
	public static final Block block = null;

	public Sign51544Block(UiModElements instance) {
		super(instance, 39);
	}
