...
public class TempSign12Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_12")
	public static final Block block = null;

	public TempSign12Block(UiModElements instance) {
		super(instance, 116);
	}
