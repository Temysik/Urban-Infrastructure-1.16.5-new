...
public class Sign8115Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8115")
	public static final Block block = null;

	public Sign8115Block(UiModElements instance) {
		super(instance, 56);
	}
