...
public class Sign3134Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3134")
	public static final Block block = null;

	public Sign3134Block(UiModElements instance) {
		super(instance, 18);
	}
