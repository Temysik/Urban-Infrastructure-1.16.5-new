...
public class Sign8222odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8222odin")
	public static final Block block = null;

	public Sign8222odinBlock(UiModElements instance) {
		super(instance, 70);
	}
