...
public class WindowBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:window")
	public static final Block block = null;

	public WindowBlock(UiModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(32, -6, 26, -15, 31, -1))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-16, -6, -10, 31, 31, 17))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(26, -6, -16, -1, 31, 31))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-10, -6, 32, 17, 31, -15))
