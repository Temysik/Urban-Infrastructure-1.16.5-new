...
public class Sign8121Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8121")
	public static final Block block = null;

	public Sign8121Block(UiModElements instance) {
		super(instance, 56);
	}
