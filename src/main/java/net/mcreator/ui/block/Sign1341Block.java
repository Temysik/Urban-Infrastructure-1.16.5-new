...
public class Sign1341Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1341")
	public static final Block block = null;

	public Sign1341Block(UiModElements instance) {
		super(instance, 13);
	}
