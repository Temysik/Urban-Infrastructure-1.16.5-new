...
public class TempSign36Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_36")
	public static final Block block = null;

	public TempSign36Block(UiModElements instance) {
		super(instance, 119);
	}
