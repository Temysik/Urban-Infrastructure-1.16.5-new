...
public class Sign5312Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5312")
	public static final Block block = null;

	public Sign5312Block(UiModElements instance) {
		super(instance, 42);
	}
