...
public class Sign51518Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51518")
	public static final Block block = null;

	public Sign51518Block(UiModElements instance) {
		super(instance, 35);
	}
