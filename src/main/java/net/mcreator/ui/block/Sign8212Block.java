...
public class Sign8212Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8212")
	public static final Block block = null;

	public Sign8212Block(UiModElements instance) {
		super(instance, 59);
	}
