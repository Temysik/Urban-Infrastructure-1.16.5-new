...
public class Sign8135odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8135odin")
	public static final Block block = null;

	public Sign8135odinBlock(UiModElements instance) {
		super(instance, 67);
	}
