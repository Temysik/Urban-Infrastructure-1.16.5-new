...
public class Sign3137Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3137")
	public static final Block block = null;

	public Sign3137Block(UiModElements instance) {
		super(instance, 18);
	}
