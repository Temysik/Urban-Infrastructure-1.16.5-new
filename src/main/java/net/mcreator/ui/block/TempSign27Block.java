...
public class TempSign27Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_27")
	public static final Block block = null;

	public TempSign27Block(UiModElements instance) {
		super(instance, 117);
	}
