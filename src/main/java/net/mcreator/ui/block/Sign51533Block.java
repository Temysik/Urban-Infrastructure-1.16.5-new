...
public class Sign51533Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51533")
	public static final Block block = null;

	public Sign51533Block(UiModElements instance) {
		super(instance, 38);
	}
