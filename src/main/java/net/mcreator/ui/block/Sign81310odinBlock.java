...
import net.mcreator.ui.itemgroup.SignsItemGroup;
...
public class Sign81310odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_81310odin")
	public static final Block block = null;

	public Sign81310odinBlock(UiModElements instance) {
		super(instance, 68);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(SignsItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sign_81310odin");
		}
