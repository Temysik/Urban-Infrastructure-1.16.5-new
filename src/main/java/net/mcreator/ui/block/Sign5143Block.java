...
public class Sign5143Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5143")
	public static final Block block = null;

	public Sign5143Block(UiModElements instance) {
		super(instance, 32);
	}
