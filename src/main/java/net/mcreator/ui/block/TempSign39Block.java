...
public class TempSign39Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_39")
	public static final Block block = null;

	public TempSign39Block(UiModElements instance) {
		super(instance, 119);
	}
