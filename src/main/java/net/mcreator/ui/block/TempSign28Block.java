...
public class TempSign28Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_28")
	public static final Block block = null;

	public TempSign28Block(UiModElements instance) {
		super(instance, 118);
	}
