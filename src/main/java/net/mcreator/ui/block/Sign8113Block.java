...
public class Sign8113Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8113")
	public static final Block block = null;

	public Sign8113Block(UiModElements instance) {
		super(instance, 55);
	}
