...
public class Sign5191Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5191")
	public static final Block block = null;

	public Sign5191Block(UiModElements instance) {
		super(instance, 40);
	}
