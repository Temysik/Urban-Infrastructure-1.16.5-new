...
public class Sign1342Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1342")
	public static final Block block = null;

	public Sign1342Block(UiModElements instance) {
		super(instance, 13);
	}
