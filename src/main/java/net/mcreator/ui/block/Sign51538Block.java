...
public class Sign51538Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51538")
	public static final Block block = null;

	public Sign51538Block(UiModElements instance) {
		super(instance, 38);
	}
