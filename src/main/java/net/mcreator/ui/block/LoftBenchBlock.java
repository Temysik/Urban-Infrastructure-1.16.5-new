...
public class LoftBenchBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:loft_bench")
	public static final Block block = null;

	public LoftBenchBlock(UiModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(25, 0, 17, -8, 10, 5))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-9, 0, -1, 24, 10, 11))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(17, 0, -9, 5, 10, 24))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-1, 0, 25, 11, 10, -8))
