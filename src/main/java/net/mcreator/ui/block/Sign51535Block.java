...
public class Sign51535Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51535")
	public static final Block block = null;

	public Sign51535Block(UiModElements instance) {
		super(instance, 38);
	}
