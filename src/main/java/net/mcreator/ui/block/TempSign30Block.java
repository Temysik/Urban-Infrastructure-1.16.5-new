...
public class TempSign30Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_30")
	public static final Block block = null;

	public TempSign30Block(UiModElements instance) {
		super(instance, 118);
	}
