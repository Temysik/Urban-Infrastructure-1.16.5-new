...
public class TempSign44Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_44")
	public static final Block block = null;

	public TempSign44Block(UiModElements instance) {
		super(instance, 120);
	}
