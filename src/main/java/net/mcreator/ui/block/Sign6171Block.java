...
public class Sign6171Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_6171")
	public static final Block block = null;

	public Sign6171Block(UiModElements instance) {
		super(instance, 49);
	}
