...
public class Sign8133odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8133odin")
	public static final Block block = null;

	public Sign8133odinBlock(UiModElements instance) {
		super(instance, 67);
	}
