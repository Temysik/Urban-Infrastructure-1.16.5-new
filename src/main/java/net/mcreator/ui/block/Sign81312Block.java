...
public class Sign81312Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_81312")
	public static final Block block = null;

	public Sign81312Block(UiModElements instance) {
		super(instance, 59);
	}
