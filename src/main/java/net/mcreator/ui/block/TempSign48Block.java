...
public class TempSign48Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_48")
	public static final Block block = null;

	public TempSign48Block(UiModElements instance) {
		super(instance, 120);
	}
