...
public class Sign8139Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8139")
	public static final Block block = null;

	public Sign8139Block(UiModElements instance) {
		super(instance, 58);
	}
