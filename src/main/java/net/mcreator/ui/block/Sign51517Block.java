...
public class Sign51517Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51517")
	public static final Block block = null;

	public Sign51517Block(UiModElements instance) {
		super(instance, 35);
	}
