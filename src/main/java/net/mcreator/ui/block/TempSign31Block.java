...
public class TempSign31Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_31")
	public static final Block block = null;

	public TempSign31Block(UiModElements instance) {
		super(instance, 118);
	}
