...
public class Sign8411Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8411")
	public static final Block block = null;

	public Sign8411Block(UiModElements instance) {
		super(instance, 64);
	}
