...
public class Sign3143Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3143")
	public static final Block block = null;

	public Sign3143Block(UiModElements instance) {
		super(instance, 19);
	}
