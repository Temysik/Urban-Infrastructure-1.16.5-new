...
public class Sign8214Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8214")
	public static final Block block = null;

	public Sign8214Block(UiModElements instance) {
		super(instance, 59);
	}
