...
public class Sign5133Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5133")
	public static final Block block = null;

	public Sign5133Block(UiModElements instance) {
		super(instance, 31);
	}
