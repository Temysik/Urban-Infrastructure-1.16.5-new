...
public class Sign8132odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8132odin")
	public static final Block block = null;

	public Sign8132odinBlock(UiModElements instance) {
		super(instance, 66);
	}
