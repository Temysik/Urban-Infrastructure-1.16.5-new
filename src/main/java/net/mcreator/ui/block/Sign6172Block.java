...
public class Sign6172Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_6172")
	public static final Block block = null;

	public Sign6172Block(UiModElements instance) {
		super(instance, 49);
	}
