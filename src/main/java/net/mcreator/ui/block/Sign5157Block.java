...
public class Sign5157Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5157")
	public static final Block block = null;

	public Sign5157Block(UiModElements instance) {
		super(instance, 33);
	}
