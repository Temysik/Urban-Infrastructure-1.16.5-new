...
public class Sign8211Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8211")
	public static final Block block = null;

	public Sign8211Block(UiModElements instance) {
		super(instance, 59);
	}
