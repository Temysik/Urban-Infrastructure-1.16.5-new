...
public class Sign3133Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3133")
	public static final Block block = null;

	public Sign3133Block(UiModElements instance) {
		super(instance, 18);
	}
