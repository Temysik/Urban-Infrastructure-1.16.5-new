...
public class Sign5155Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5155")
	public static final Block block = null;

	public Sign5155Block(UiModElements instance) {
		super(instance, 33);
	}
