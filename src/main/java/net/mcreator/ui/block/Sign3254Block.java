...
public class Sign3254Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3254")
	public static final Block block = null;

	public Sign3254Block(UiModElements instance) {
		super(instance, 21);
	}
