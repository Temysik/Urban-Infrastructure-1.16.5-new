...
public class TempSign25Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_25")
	public static final Block block = null;

	public TempSign25Block(UiModElements instance) {
		super(instance, 117);
	}
