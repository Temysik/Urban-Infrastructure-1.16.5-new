...
public class Sign51515Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51515")
	public static final Block block = null;

	public Sign51515Block(UiModElements instance) {
		super(instance, 35);
	}
