...
public class Sign51541Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51541")
	public static final Block block = null;

	public Sign51541Block(UiModElements instance) {
		super(instance, 39);
	}
