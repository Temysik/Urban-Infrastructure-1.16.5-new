...
public class TrashCanStreetBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:trash_can_street")
	public static final Block block = null;

	public TrashCanStreetBlock(UiModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("trash_can_street");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(14, 0, 14, 3, 12, 3))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(2, 0, 2, 13, 12, 13))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(14, 0, 2, 3, 12, 13))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(2, 0, 14, 13, 12, 3))
