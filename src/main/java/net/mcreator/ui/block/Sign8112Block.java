...
public class Sign8112Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8112")
	public static final Block block = null;

	public Sign8112Block(UiModElements instance) {
		super(instance, 55);
	}
