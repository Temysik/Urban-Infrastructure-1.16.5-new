...
public class TempSign42Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_42")
	public static final Block block = null;

	public TempSign42Block(UiModElements instance) {
		super(instance, 119);
	}
