...
public class Sign51536Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51536")
	public static final Block block = null;

	public Sign51536Block(UiModElements instance) {
		super(instance, 38);
	}
