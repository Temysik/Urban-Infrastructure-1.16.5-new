...
public class Sign3253Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3253")
	public static final Block block = null;

	public Sign3253Block(UiModElements instance) {
		super(instance, 21);
	}
