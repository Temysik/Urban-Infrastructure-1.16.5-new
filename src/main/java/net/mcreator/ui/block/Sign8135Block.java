...
public class Sign8135Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8135")
	public static final Block block = null;

	public Sign8135Block(UiModElements instance) {
		super(instance, 57);
	}
