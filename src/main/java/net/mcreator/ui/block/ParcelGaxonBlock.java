...
public class ParcelGaxonBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:parcel_gaxon")
	public static final Block block = null;

	public ParcelGaxonBlock(UiModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(32, -16, 17, -15, 31, -5))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-16, -16, -1, 31, 31, 21))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(17, -16, -16, -5, 31, 31))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-1, -16, 32, 21, 31, -15))
