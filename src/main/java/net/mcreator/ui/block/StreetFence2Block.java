...
public class StreetFence2Block extends UiModElements.ModElement {
	@ObjectHolder("ui:street_fence_2")
	public static final Block block = null;

	public StreetFence2Block(UiModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("street_fence_2");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 3, 1, 18, -1))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 0, 13, 15, 18, 17))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(3, 0, 0, -1, 18, 15))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(13, 0, 16, 17, 18, 1))
