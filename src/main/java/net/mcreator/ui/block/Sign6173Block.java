...
public class Sign6173Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_6173")
	public static final Block block = null;

	public Sign6173Block(UiModElements instance) {
		super(instance, 49);
	}
