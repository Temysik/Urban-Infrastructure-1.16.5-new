...
public class Sign51529Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51529")
	public static final Block block = null;

	public Sign51529Block(UiModElements instance) {
		super(instance, 37);
	}
