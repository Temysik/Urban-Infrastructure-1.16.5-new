...
public class Sign8131odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8131odin")
	public static final Block block = null;

	public Sign8131odinBlock(UiModElements instance) {
		super(instance, 66);
	}
