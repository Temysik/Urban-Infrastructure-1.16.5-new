...
public class Sign8116Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8116")
	public static final Block block = null;

	public Sign8116Block(UiModElements instance) {
		super(instance, 56);
	}
