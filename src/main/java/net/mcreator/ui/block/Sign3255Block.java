...
public class Sign3255Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3255")
	public static final Block block = null;

	public Sign3255Block(UiModElements instance) {
		super(instance, 21);
	}
