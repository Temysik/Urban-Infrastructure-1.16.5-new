...
public class Sign8134Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8134")
	public static final Block block = null;

	public Sign8134Block(UiModElements instance) {
		super(instance, 57);
	}
