...
public class Sign5322Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5322")
	public static final Block block = null;

	public Sign5322Block(UiModElements instance) {
		super(instance, 43);
	}
