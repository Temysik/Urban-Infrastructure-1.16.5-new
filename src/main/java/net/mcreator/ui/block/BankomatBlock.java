...
public class BankomatBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:bankomat")
	public static final Block block = null;

	public BankomatBlock(UiModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, -16, 17, 0, 20, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, -16, -1, 16, 20, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(17, -16, 0, 0, 20, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-1, -16, 16, 16, 20, 0))
