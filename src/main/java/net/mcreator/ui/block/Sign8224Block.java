...
public class Sign8224Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8224")
	public static final Block block = null;

	public Sign8224Block(UiModElements instance) {
		super(instance, 60);
	}
