...
public class Sign7141Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_7141")
	public static final Block block = null;

	public Sign7141Block(UiModElements instance) {
		super(instance, 53);
	}
