...
public class TempSign26Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_26")
	public static final Block block = null;

	public TempSign26Block(UiModElements instance) {
		super(instance, 117);
	}
