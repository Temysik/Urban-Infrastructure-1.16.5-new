...
public class Sign5142Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5142")
	public static final Block block = null;

	public Sign5142Block(UiModElements instance) {
		super(instance, 32);
	}
