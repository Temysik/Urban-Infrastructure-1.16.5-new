...
public class TempSign46Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_46")
	public static final Block block = null;

	public TempSign46Block(UiModElements instance) {
		super(instance, 120);
	}
