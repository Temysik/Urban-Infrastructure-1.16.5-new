...
public class VeloparkingBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:veloparking")
	public static final Block block = null;

	public VeloparkingBlock(UiModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(18, 0, 18, -1, 15, 1))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-2, 0, -2, 17, 15, 15))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(18, 0, -2, 1, 15, 17))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(-2, 0, 18, 15, 15, -1))
