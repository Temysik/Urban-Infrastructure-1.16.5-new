...
public class Sign8221Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8221")
	public static final Block block = null;

	public Sign8221Block(UiModElements instance) {
		super(instance, 60);
	}
