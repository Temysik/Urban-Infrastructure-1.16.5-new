...
public class Sign51540Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51540")
	public static final Block block = null;

	public Sign51540Block(UiModElements instance) {
		super(instance, 39);
	}
