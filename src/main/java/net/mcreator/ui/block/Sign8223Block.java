...
public class Sign8223Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8223")
	public static final Block block = null;

	public Sign8223Block(UiModElements instance) {
		super(instance, 60);
	}
