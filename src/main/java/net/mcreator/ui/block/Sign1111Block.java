...
public class Sign1111Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_1111")
	public static final Block block = null;

	public Sign1111Block(UiModElements instance) {
		super(instance, 8);
	}
