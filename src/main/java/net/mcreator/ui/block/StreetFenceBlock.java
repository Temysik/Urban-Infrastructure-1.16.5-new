...
public class StreetFenceBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:street_fence")
	public static final Block block = null;

	public StreetFenceBlock(UiModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 3, 1, 17, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 0, 13, 15, 17, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(3, 0, 0, 0, 17, 15))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(13, 0, 16, 16, 17, 1))
