...
public class Sign8211odinBlock extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8211odin")
	public static final Block block = null;

	public Sign8211odinBlock(UiModElements instance) {
		super(instance, 69);
	}
