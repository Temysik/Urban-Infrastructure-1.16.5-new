...
public class TempSign32Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_32")
	public static final Block block = null;

	public TempSign32Block(UiModElements instance) {
		super(instance, 118);
	}
