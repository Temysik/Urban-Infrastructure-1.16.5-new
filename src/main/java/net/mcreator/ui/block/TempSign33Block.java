...
public class TempSign33Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_33")
	public static final Block block = null;

	public TempSign33Block(UiModElements instance) {
		super(instance, 118);
	}
