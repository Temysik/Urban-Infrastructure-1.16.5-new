...
public class Sign5152Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5152")
	public static final Block block = null;

	public Sign5152Block(UiModElements instance) {
		super(instance, 32);
	}
