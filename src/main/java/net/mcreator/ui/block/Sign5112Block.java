...
public class Sign5112Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_5112")
	public static final Block block = null;

	public Sign5112Block(UiModElements instance) {
		super(instance, 30);
	}
