...
public class Sign3182Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3182")
	public static final Block block = null;

	public Sign3182Block(UiModElements instance) {
		super(instance, 19);
	}
