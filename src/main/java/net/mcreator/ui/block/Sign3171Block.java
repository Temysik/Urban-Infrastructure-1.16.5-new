...
public class Sign3171Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3171")
	public static final Block block = null;

	public Sign3171Block(UiModElements instance) {
		super(instance, 19);
	}
