...
public class TempSign43Block extends UiModElements.ModElement {
	@ObjectHolder("ui:temp_sign_43")
	public static final Block block = null;

	public TempSign43Block(UiModElements instance) {
		super(instance, 119);
	}
