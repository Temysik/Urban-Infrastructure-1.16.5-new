...
public class Sign51523Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51523")
	public static final Block block = null;

	public Sign51523Block(UiModElements instance) {
		super(instance, 36);
	}
