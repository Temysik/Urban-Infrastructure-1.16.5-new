...
public class Sign8131Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_8131")
	public static final Block block = null;

	public Sign8131Block(UiModElements instance) {
		super(instance, 57);
	}
