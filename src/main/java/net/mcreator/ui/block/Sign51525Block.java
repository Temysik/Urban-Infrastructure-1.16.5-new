...
public class Sign51525Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_51525")
	public static final Block block = null;

	public Sign51525Block(UiModElements instance) {
		super(instance, 36);
	}
