...
public class Sign3136Block extends UiModElements.ModElement {
	@ObjectHolder("ui:sign_3136")
	public static final Block block = null;

	public Sign3136Block(UiModElements instance) {
		super(instance, 18);
	}
